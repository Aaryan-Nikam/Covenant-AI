...
import "./OperationsFunctions.css";
import {
  createCovenant,
...
export function OperationsFunctions() {
  const [activePage, setActivePage] = useState<any>("operations-functions");
    ...
    <AppShell activePage={activePage} onNavigate={setActivePage}>
      <div className="ip-page-header">
        <div className="ip-page-header-left">
          <div className="ip-page-title">Operations Function Suite</div>
          <div className="ip-page-subtitle">
            High-ticket business workflows running on top of the core compliance layer
            {apiLive && (
